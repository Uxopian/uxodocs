...
!(function (a, b, c) {
    ...
    function d(c) {
        ...
        ((ta = c.edgeStrategy || "set"),
            ...
            Sa
                ? ((ja = b.getElementById(c.skrollrBody || z)), ja && ga(), X(), Ea(e, [s, v], [t]))
                : Ea(e, [s, u], [t]),
            ha.refresh(),
        ...
        T = function () {
            ...
            if (j) {
                ...
                ((R = R[0]),
                    "-" === R.slice(0, 1)
                        ? ((S = R),
                          (R = { "-webkit-": "webkit", "-moz-": "Moz", "-ms-": "ms", "-o-": "O" }[
                              R
                          ]))
                        : (S = "-" + R.toLowerCase() + "-"));
            }
            ...
            for (var c = 0, d = ia.length; d > c; c++) {
                ...
                if (t || u) {
                    ...
                    switch (
                        (t
                            ? (Ea(j, [p], [r, q]),
                              w && x > -1 && (za(j, n.eventType, La), (i.lastFrameIndex = -1)))
                            : (Ea(j, [r], [p, q]),
    ...
    var ha,
        ...
        Da = function (b) {
            var c = "className";
            return (
                a.SVGElement && b instanceof a.SVGElement && ((b = b[c]), (c = "baseVal")),
                b[c]
            );
        },
        Ea = function (b, d, e) {
            var f = "className";
            if (
                (a.SVGElement && b instanceof a.SVGElement && ((b = b[f]), (f = "baseVal")),
                e === c)
            )
                return void (b[f] = d);
