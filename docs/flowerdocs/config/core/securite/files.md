...
last_update:
  ...
  author: CI/CD Bot
content_hash: 32db7234d7a555f8edfe9d788f2fad6cfbed7d0d761d83aa787b20c121d201f0
---
...
```properties
java -jar flower-docs-clm-2.8.3-bundle.jar dir analyze --input=<directory to analyze>
```
...
```properties
java -jar flower-docs-clm-2.8.3-bundle.jar dir encrypt --input=<directory to encrypt> --output=<target directory with encrypted data> --conf=<config file path>
```
