...
last_update:
  ...
  author: CI/CD Bot
content_hash: 9ae50648756c7d9bc243c607d5f8b1de3ad278333f0fcfe25ea7dfd91ae185af
---
...
**Example:** Defining the context menu for the `DefaultSearch` document search form
...
Example :\_\_ Adding an `exportToCRM` JavaScript action to the context menu of the `DefaultSearch` document search form
