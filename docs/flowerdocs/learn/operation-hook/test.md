...
- `OperationHandler`: enter the hook's HTTP URL (e.g. _http://localhost:7777/modify_).
...
- `Authorization`: fill in the BASIC authorisation string using [Blitter](https://www.blitter.se/utils/basic-authentication-header-generator/) from the user defined in the _application.properties_ file (example: Basic dG90bzoxMjM0)
