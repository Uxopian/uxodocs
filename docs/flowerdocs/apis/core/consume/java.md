...
last_update:
  ...
  author: CI/CD Bot
content_hash: c8ab821868d946a4dd8fda7862b72e1c437491fb706d40adffa8348fc58b5512
---

:::info
The Java client lets you interact with FlowerDocs Core through the web services on display.

This documentation is based on the use of [Maven](https://maven.apache.org/) and [Spring Boot 2.7] (https://spring.io/projects/spring-boot).
:::

<div className="card margin-bottom--md">
  <div className="card__header">
    <h3><a href="https://flowerdocs.com/javadocs/service/index.html" target="_blank">Core Services</a></h3>
  </div>
  <div className="card__body">
    <p>Services Javadoc</p>
  </div>
</div>
