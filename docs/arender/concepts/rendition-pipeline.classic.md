...
The document is loaded into the service broker — either through a connector or directly by URL. The broker stores the original file in the shared temporary volume (`/arender/tmp`).
