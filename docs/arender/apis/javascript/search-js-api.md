...
- Object: getARenderJS().getSearchJSAPI()
    ...
    | -------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- | ---------------------------- |
    | askAdvancedSearchText(searchText,isCaseSensitive,isAccentSensitive,isRegex,SearchAction,searchAnnotation,postSearchAction) | Advanced search                     | **searchText**: (String) the text searched;<br/>**isCaseSensitive**: (boolean);<br/>**isAccentSensitive**: (boolean);<br/>**isRegex**: (boolean);<br/>**SearchAction**: (String) [null, CurrentPage, AllPages, AllDocuments];<br/>**searchAnnotation**: (String) [WithAnnotations, WithoutAnnotations, OnlyAnnotations];<br/>**postSearchAction**: (String) [null, Redact, Highlight] |
...
For example, `\b\w{16,}\b` will match words containing more than 16 characters.
