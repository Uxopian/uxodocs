...
For Alfresco-specific integration (Share plugin, Alfresco site roles, ADF/ACA), see the [Alfresco integration guide](./alfresco.mdx). This page covers generic CMIS configuration and non-Alfresco use cases.
