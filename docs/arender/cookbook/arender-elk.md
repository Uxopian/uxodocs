...
* For version allowing .ndjson file import (Since Kibana 7.2.0):
    ...
    * Then import dashboard. Click on import and select the file : [ Arender-dashboard-example.ndjson](/docs/ELK/Arender-dashboard-example.ndjson)
* For version only allowing .json file import :
    * First import visualization. Click on import and select the file :  [ Arender-visualizations.json](/docs/ELK/Arender-visualizations.json)
