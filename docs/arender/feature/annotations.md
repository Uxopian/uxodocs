...
last_update:
  ...
  author: CI/CD Bot
content_hash: f35fce9d1389252093b299b1b4130296bd9c311408cb4a221803386ba4bfc81f
---
...
![image](pathname:///img/arender/annotations1.png)

And the annotation menu appears:

![image](pathname:///img/arender/annotations2.png)

You can also access the annotations with a right-click on the document:

![image](pathname:///img/arender/annotations3.png)
...
![image](pathname:///img/arender/annotations4.png)
...
![image](pathname:///img/arender/annotations5.png)
...
![image](pathname:///img/arender/annotations6.png)

or you can right-click on the document and choose "Add sticky note" in
the menu:

![image](pathname:///img/arender/annotations7.png)

Then, you drag and drop your cursor on the document:

![image](pathname:///img/arender/annotations8.png)
...
![image](pathname:///img/arender/annotations10.png)
...
![image](pathname:///img/arender/annotations16.png)

Annotation details appear in a pop-in:

![image](pathname:///img/arender/annotations17.png)
...
![image](pathname:///img/arender/annotations18.png)
...
![image](pathname:///img/arender/annotations22.png)
...
![image](pathname:///img/arender/annotations23.png)
...
![image](pathname:///img/arender/annotations24.png)

or you can right-click on the document and choose "Add arrow" in the
menu:

![image](pathname:///img/arender/annotations25.png)
...
![image](pathname:///img/arender/annotations29.png)
...
![image](pathname:///img/arender/annotations30.png)
