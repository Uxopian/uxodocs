...
Two conventions hold across the API: reads are synchronous, and actions return a promise. Annotation methods are grouped under `annotations`; the rest sit directly on the root object.
