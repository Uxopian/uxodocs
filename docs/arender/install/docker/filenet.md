...
ARender UI for FileNet images tag are prefixed with "-filenet" (e.g arender-ui:VERSION-filenet) since ARender 4.3.0.
...
```bash
$> docker run DOCKER-REGISTRY/arender-ui:VERSION-filenet \
