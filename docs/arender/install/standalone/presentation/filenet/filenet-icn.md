...
you can retrieve the navigator plugin [here](https://artifactory.arondor.cloud/artifactory/arondor-all/com/arondor/arender/arondor-arender-navigator-plugin/4.8.21/arondor-arender-navigator-plugin-4.8.21.jar)
