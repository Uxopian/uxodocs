...
- **[The Migration Ledger](./migration-ledger.md)**: how you know what's done, what's left, and what to re-run, without interrogating the source to find out. The inventory-as-work-queue pattern, the schema and state machine, atomic claims and leases, and why the ledger never certifies itself. Part 3 of the migration series.
