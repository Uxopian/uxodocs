...
| Translate to French | `translate` | Translation with `targetLanguage=french` payload |
| Translate to English | `translate` | Translation with `targetLanguage=english` payload |
