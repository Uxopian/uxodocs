...
sidebar_position: 8
content_hash: 4e21e4a2eaa6eb933f6f51cac0e4836b6e2d33f894ce65ccb907d7357413fb87
---
...
|---|---|
| `token` | Returns a signed RS256 JWT for the current ICN user — used by the browser to authenticate web component asset requests |
...
Download the plugin source package to deploy a prebuilt JAR or rebuild it for your environment.

:::tip[Download]
**<a href={require('./uxopian-icn-plugin.zip').default} download="uxopian-icn-plugin.zip">uxopian-icn-plugin.zip</a>**
:::
...
### 4.3 Test the context menu action in ICN
...
5. Verify the **AI Chat** toolbar button (chat icon) appears in the ICN navigation bar.
...
| ICN toolbar | AI Chat button injected |
...
- The `openChat` function (invoked by the context menu action and toolbar button)
