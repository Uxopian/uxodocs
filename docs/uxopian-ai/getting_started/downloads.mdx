...
last_update:
  ...
  author: CI/CD Bot
content_hash: 21a5a7c0b402e9d571c4a1b7399745615964792708bff56cac5d335a57bd417c
---
...
See [Getting started with FileNet](./quickstart_filenet.mdx) for the integration path, or [Integrate with FileNet](../how_to/integrate_with_filenet.mdx) for deployment instructions.
...
- [Getting started with FileNet](./quickstart_filenet.mdx)
