            ...
            <div className="container">
                <div className={styles.layoutWrapper}>
                    <div className={styles.leftColumn}>
                        <h1 className={styles.mainTitle}>Welcome to Fast2 official documentation</h1>
                        ...
                        <p className={styles.sectionContent}>
                            <strong>Advanced</strong> For developers and integrators, the API Reference section provides detailed documentation on the available APIs, libraries, and SDKs offered by Fast2. This resource will assist you in integrating Fast2 with other systems, extending its capabilities, and building custom applications.
                        </p>
                        ...
                        <div className={styles.infoBox}>
                            <p>
                                For advanced questions or further assistance, please head out to the <a href="https://arondor.atlassian.net/servicedesk/customer/portals" target="_blank" rel="noopener noreferrer">Fast2 Support Customer Portal</a>.
                            </p>
                        </div>
