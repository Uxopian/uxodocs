                ...
                <div className="uxo-footer-grid">
                    <div className="uxo-footer-column">
                        ...
                        <ul>
                            <li>
                                <a
                                    href="https://arondor.atlassian.net/servicedesk/customer/portal"
                                    target="_blank"
                                    rel="noreferrer"
                                >
                                    Support
                    ...
                    <div className="uxo-footer-column">
                        ...
                        <ul>
                            <li>
                                <a href="https://uxopian.com" target="_blank" rel="noreferrer">
                                    About Us
                                </a>
                            </li>
                            <li>
                    ...
                    <div className="uxo-footer-column">
                        ...
                        <div className="uxo-footer-social">
                            <a
                                ...
                                href="https://www.linkedin.com/company/uxopiansoftware/"
                                target="_blank"
                                rel="noreferrer"
                                aria-label="LinkedIn"
                            >
