...
function detectProductFromUrl(url: string): string | null {
  ...
  if (lowerUrl.match(/\/docs\/arender[\/\?#]|docs\/arender[\/\?#]|\/docs\/arender$/)) return 'arender';
  if (lowerUrl.match(/\/docs\/fast2[\/\?#]|docs\/fast2[\/\?#]|\/docs\/fast2$/)) return 'fast2';
  if (lowerUrl.match(/\/docs\/flowerdocs[\/\?#]|docs\/flowerdocs[\/\?#]|\/docs\/flowerdocs$/)) return 'flowerdocs';
  if (lowerUrl.match(/\/docs\/uxopian-ai[\/\?#]|docs\/uxopian-ai[\/\?#]|\/docs\/uxopian-ai$/)) return 'uxopian-ai';
  return null;
}
